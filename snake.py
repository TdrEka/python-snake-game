...
class SNAKE:
    ...
    def draw_snake(self):
        ...
        for index, block in enumerate(self.body):
            ...
            #2. what direction is the head facing?
            if index == 0:
...
class MAIN:
    ...
    def draw_score(self):
        ...
        bg_rect = pygame.Rect(apple_rect.left, apple_rect.top,apple_rect.width + 6 + score_rect.width ,apple_rect.height)
        
        pygame.draw.rect(screen, (167,209,61), bg_rect)
        screen.blit(score_surface, score_rect)
        screen.blit(apple, apple_rect)
        pygame.draw.rect(screen, (64,74,12),bg_rect,2)
